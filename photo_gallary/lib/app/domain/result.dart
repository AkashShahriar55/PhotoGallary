...
sealed class Result<T> {
  ...
  R when<R>({
    ...
    return switch (this) {
      ...
      Error<T>(:var error, :var stackTrace) => onError(error, stackTrace),
    };
  }
  ...
  Result<R> map<R>(R Function(T value) transform) {
    return switch (this) {
      Ok<T>(:var value) => Result.ok(transform(value)),
      Error<T>(:var error, :var stackTrace) => Result.error(error, stackTrace),
    };
  }
}
